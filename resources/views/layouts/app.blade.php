...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/js/plugins/flatpickr/plugins/monthSelect/style.css') }}">
    <!-- OneUI framework -->
...
<body>
    ...
    <script src="{{ asset('assets/js/plugins/flatpickr/plugins/monthSelect/index.js') }}"></script>
    <!-- Flatpicker -->
